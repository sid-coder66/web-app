const homeContent = {
  ...
  serviceAreas: [
    ...
    {
      title: 'Accounting and Financial Reporting Support',
      description: 'We empower firms to streamline book keeping, financial reporting and month end processes.',
      icon: 'FaBalanceScale',
      features: [
        { title: 'Bookkeeping Excellence', description: 'Transaction processing, reconciliations, and ledger management for reliable and up-to-date financial records.' },
        { title: 'Month-End Close Management', description: 'Structured close processes and working papers to deliver faster and error-free reporting cycles.' },
      ],
    },
    {
  ...
  faq: [
    { question: 'What exactly does ComplyWise do?', answer: 'We help audit and accounting firms streamline and scale their audit delivery — from clean trial balances to final review-ready workpapers. Our team in India handles the heavy lifting, while UK and Canada-based team members ensure responsive, familiar support. Whether you need an offshore audit team, help with documentation and compliance, or guidance on structuring your audit process, we deliver files the way you work — without the hiring.' },
